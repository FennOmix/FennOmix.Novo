...
class DeNovoAPI:
    """
    High-level API for FoxNovo de novo peptide sequencing model.
    ...
    def train(
        ...
        **kwargs,
        ...
        """
            Train the DeNovo model on new data.
            Args:
        ...
        # Train model
        logger.info("=" * 70)
        logger.info("DENOVO MODEL TRAINING")
        logger.info("=" * 70)
    ...
    def predict(
        ...
        """
            Run prediction on MS/MS spectra using the DeNovo model.
            The DeNovo model uses a dual decoder system (NAR + DP) and provides:
        ...
        # Run prediction
        logger.info("=" * 70)
        logger.info("DENOVO MODEL PREDICTION")
        logger.info("=" * 70)
...
def train(train_folder: str, val_folder: str, model_weights: str | None = None, **kwargs) -> None:
    ...
    Args:
        ...
        model_weights (Optional[str]): Path to pre-trained model weights.
        **kwargs: Additional arguments passed to DeNovoAPI.train()
    Examples:
        >>> from foxnovo.api import train
        >>> train(
        ...     train_folder="/data/train",
...
def create_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        prog="foxnovo",
        description="FoxNovo - DeNovo Peptide Sequencing Model",
        epilog="For more information, visit the project repository.",
    )
    subparsers = parser.add_subparsers(dest="command", help="Available commands")
    # ==================== TRAIN COMMAND ====================
    train_parser = subparsers.add_parser("train", help="Train the DeNovo model")
