...
def prepare_batch(batch):
    ...
    if is_annotated:
        spectra, precursor_mzs, precursor_charges, peptides, raw_names, spec_idx, score = list(zip(*batch, strict=False))
    else:
...
class DeNovoDataModule:
    ...
    def setup(self):
        ...
        try:
            ...
            raise ValueError("Failed to initialize datasets. Please check the file paths and dataset parameters.") from e
